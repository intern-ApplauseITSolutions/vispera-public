...
// Header image
import headerImg from "../../assets/images/service5/header.jpg";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-48 sm:h-56 md:h-72 lg:h-80 overflow-hidden">
        <img
          src={headerImg}
          alt="Creative Graphic Design And Brand Identity"
          ...
          <div className="max-w-7xl mx-auto px-8 md:px-16 w-full">
            ...
            >
              <h1 className="text-sm sm:text-base md:text-lg lg:text-2xl font-bold text-white mb-2 sm:mb-3 leading-tight">
                Creative Graphic Design And Brand Identity
              </h1>
              <p className="text-[10px] sm:text-[11px] md:text-sm text-white/90 leading-relaxed">
                We create thoughtful design systems and visual assets that reflect your brand's identity
                and purpose. From branding to campaign creatives, our work is crafted to communicate clearly across
                digital and print.
              </p>
            </motion.div>
          </div>
