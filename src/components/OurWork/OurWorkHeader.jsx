...
export default function OurWorkHeader({ onSearch, onSort }) {
  ...
  return (
    <div className="w-full bg-bg-light">
      <div className="w-full px-8 md:px-8 lg:px-12 xl:px-16 py-6 md:py-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-12 items-stretch md:items-center px-2 md:px-2 lg:px-4 xl:px-2">
          {/* Search Bar */}
          <div className="relative flex-1 max-w-[2500px]">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3 sm:py-3.5 md:py-2 rounded-2xl border-2 border-[#5EA4A4] bg-white text-[#0A374C] placeholder-gray-400 focus:outline-none focus:border-[#5EA4A4] transition-all text-sm md:text-base"
              />
