...
import img1 from "../../assets/images/OurWork3/img1.png";
import img2 from "../../assets/images/OurWork3/img2.png";
import img3 from "../../assets/images/OurWork3/img3.png";
import img4 from "../../assets/images/OurWork3/img4.png";
import img5 from "../../assets/images/OurWork3/img5.png";
import img6 from "../../assets/images/OurWork3/img6.png";
import img7 from "../../assets/images/OurWork3/img7.png";
import img8 from "../../assets/images/OurWork3/img8.png";
...
const allProjects = [
  { 
    ...
    link: "https://youtu.be/mUzWwi8ClQI?si=EWl44ReTqmgx74vm"
  },
  { 
    id: 2, 
    title: "जलस्रोतों का पुनर्जीवीकरण - गाद की उपयोगिता Rejuvenation of Waterbodies - Silt Use", 
    badge: "Film",
    image: img2,
    client: "Project Film",
    location: "Location",
    overview: "Project description goes here.",
    link: "https://youtu.be/FlErWk7o7N0?si=ccsCYnoxdxn2E-cK"
  },
  { 
    id: 3, 
    title: "जलस्रोतों का पुनर्जीवीकरण -मशीनो की भूमिका Rejuvenation of Waterbodies - Machine use", 
    badge: "Film",
    image: img3,
    client: "Project Film",
    location: "Location",
    overview: "Project description goes here.",
    link: "https://youtu.be/M29Fd8sICeo?si=OcD1ZioG3x2tsAYW"
  },
  { 
    id: 4, 
    title: "जलस्रोतों का पुनर्जीवीकरण - प्रशिक्षण के तकनीकी पहलू Technical Aspects of Desilting", 
    badge: "Film",
    image: img4,
    client: "Project Film",
    location: "Location",
    overview: "Project description goes here.",
    link: "https://youtu.be/_rQiI2y7SAg?si=LkgbHUzH-3H9Rphx"
  },
  { 
    id: 5, 
    title: "जलस्रोतों का पुनर्जीवीकरण - जिला प्रशासन की भूमिका एवं उत्तरदायित्व", 
    badge: "Film",
    image: img5,
    client: "Project Film",
    location: "Location",
    overview: "Project description goes here.",
    link: "https://youtu.be/8SbpGY96Xyw?si=H0vo4wYckxcCYjEr"
  },
  { 
    id: 6, 
    title: "जलस्रोतों का पुनर्जीवीकरण - गैर सरकारी संगठनों (NGO) की भूमिका एवं उत्तरदायित्व", 
    badge: "Film",
    image: img6,
    client: "Project Film",
    location: "Location",
    overview: "Project description goes here.",
    link: "https://youtu.be/vYnXLmkGT-k?si=ENdloe1UbHu8qSqX"
  },
  { 
    id: 7, 
    title: "जलस्रोतों का पुनर्जीवीकरण - परियोजना से सम्बंधित प्रक्रियाओं का अभिलेखीकरण", 
    badge: "Film",
    image: img7,
    client: "Project Film",
    location: "Location",
    overview: "Project description goes here.",
    link: "https://youtu.be/Fgh2dFMPoqI?si=MY_1GzB9Is8BtAbB"
  },
  { 
    id: 8, 
    title: "Project Lead, Block Coordinator एवं Site Supervisor से सम्बंधित भूमिकाएं एवम उत्तरदायित्व", 
    badge: "Film",
    image: img8,
    client: "Project Film",
    location: "Location",
    overview: "Project description goes here.",
    link: "https://youtu.be/5hjkTHvgsV0?si=w_S8ybYSq8MSnpny"
  },
];

export default function FilmsFromProject({ searchQuery = "", sortBy = "Latest" }) {
            ...
            <div className="contents sm:hidden">
              <AnimatePresence mode="popLayout">
                {currentCards.map((project, index) => {
                  // Render blank card
                  if (project.isBlank) {
                    return <DummyProjectCard key={project.id} badgeLabel="Film" buttonLabel="Watch Video" />;
                  }
                ...
                >
                  ...
                  <div className="absolute -bottom-24 left-0 w-full flex justify-center pb-6 lg:pb-8 transition-all duration-500 ease-in-out group-hover:bottom-0 z-20">
                    <button className="bg-[#5EA4A4] hover:bg-[#0A374C] text-white text-[10px] font-bold uppercase tracking-widest py-2.5 px-8 rounded shadow-lg cursor-pointer">Watch Video</button>
                  </div>
                </motion.div>
                  );
                })}
            ...
            {showMore && (
              <>
                {[1, 2, 3, 4, 5, 6, 7, 8].map((blankIndex) => (
                  <DummyProjectCard key={`more-blank-${blankIndex}`} badgeLabel="Film" buttonLabel="Watch Video" />
                ))}
              </>
            )}
            </div>
