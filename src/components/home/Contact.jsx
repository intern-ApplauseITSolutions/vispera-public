      ...
      <div className="w-full px-6 md:px-16 lg:px-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 items-end">
          ...
          >
            ...
            <div
              className="rounded-[2rem] p-6 space-y-4 lg:space-y-2 xl:space-y-4 border-2 border-[#5EA4A4] shadow-sm flex flex-col justify-between w-full md:w-[340px] lg:w-[280px] xl:w-[340px]"
              style={{ 
            ...
            >
              {/* Phone */}
              <div>
                <p className="text-[#0A374C] font-bold text-base mb-2">Quick Contact</p>
                <div className="flex items-center gap-3 lg:gap-2.5 xl:gap-4">
                  ...
                  <div>
                    <p className="text-[#5EA4A4] text-[10px] font-bold uppercase tracking-widest">Main Office</p>
                    <p className="text-[#0A374C] text-xs font-bold">+91 9767346346</p>
                  </div>
                </div>
              </div>

              <div className="border-t border-gray-100 pt-2 lg:pt-1.5 xl:pt-3">
                <p className="text-[#0A374C] font-bold text-base mb-2">Email</p>
                <div className="flex items-center gap-3 lg:gap-2.5 xl:gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#0A374C] flex items-center justify-center shrink-0">
                    <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" className="w-4 h-4">
                  ...
                  <div>
                    <p className="text-[#5EA4A4] text-[10px] font-bold uppercase tracking-widest">Mail to</p>
                    <p className="text-[#0A374C] text-xs font-bold">contact@visperastudios.in</p>
                  </div>
                </div>
              </div>

              <div className="border-t border-gray-100 pt-2 lg:pt-1.5 xl:pt-3">
                <p className="text-[#0A374C] font-bold text-base mb-2">Address</p>
                <div className="flex items-start gap-3 lg:gap-2.5 xl:gap-4">
                  ...
                  <div>
                    <p className="text-[#5EA4A4] text-[10px] font-bold uppercase tracking-widest">Our Office</p>
                    <p className="text-[#0A374C] text-xs font-bold leading-relaxed">
          ...
          >
            <div className="relative rounded-[2rem] overflow-hidden w-full max-w-[220px] md:max-w-[260px] lg:max-w-[270px] xl:max-w-[300px]" style={{ height: "400px" }}>
              <img
                src={contactImg}
          ...
          >
            <div className="mb-6 h-[140px] flex flex-col justify-end w-full max-w-[340px] md:hidden lg:flex">
              <p className="text-[#5EA4A4] text-sm font-semibold tracking-widest uppercase mb-1">
